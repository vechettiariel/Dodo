...
public class JRootApp extends JPanel implements AppView {
    ...
    private IInvoiceValidation invoiceValidation;
    ...
    public boolean initApp(AppProperties props) {
        ...
        try {
            invoiceValidation = InvoiceValidation.getValidation(m_props);
            invoiceValidation.checkConnexion();

        } catch (BasicException e) {
            MessageInf msg = new MessageInf(MessageInf.SGN_NOTICE, AppLocal.getIntString("message.cannotinvoicevalidacion"), e);
            msg.show(this);
            session.close();
            return false;
