...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administrador role', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Gerente role', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Empleado role', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Invitado role', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('18', 'billete.100pesos', 1, $FILE{/com/openbravo/pos/templates/billete.100pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'billete.10pesos', 1, $FILE{/com/openbravo/pos/templates/billete.10pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'billete.20pesos', 1, $FILE{/com/openbravo/pos/templates/billete.20pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'billete.2pesos', 1, $FILE{/com/openbravo/pos/templates/billete.2pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'billete.50pesos', 1, $FILE{/com/openbravo/pos/templates/billete.50pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'billete.5pesos', 1, $FILE{/com/openbravo/pos/templates/billete.5pesos.png});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'moneda.10centavos', 1, $FILE{/com/openbravo/pos/templates/moneda.10centavos.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'moneda.1peso', 1, $FILE{/com/openbravo/pos/templates/moneda.1peso.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'moneda.25centavos', 1, $FILE{/com/openbravo/pos/templates/moneda.25centavos.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'moneda.50centavos', 1, $FILE{/com/openbravo/pos/templates/moneda.50centavos.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('28', 'moneda.5centavos', 1, $FILE{/com/openbravo/pos/templates/moneda.5centavos.jpg});
...
INSERT INTO taxcategories (id, name) VALUES ('002', 'Iva General');
INSERT INTO taxcategories (id, name) VALUES ('001', 'Iva Reducido');
INSERT INTO taxcategories (id, name) VALUES ('000', 'Iva Exento');
...
ALTER TABLE tickets ADD COLUMN vendedor character varying;
ALTER TABLE tickets ADD CONSTRAINT tickets_fk_vendedor FOREIGN KEY (vendedor) REFERENCES people (id) MATCH SIMPLE  ON UPDATE NO ACTION ON DELETE NO ACTION;
