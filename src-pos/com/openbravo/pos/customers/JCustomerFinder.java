...
public class JCustomerFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void init(DataLogicCustomers dlCustomers) {
        ...
        m_jtxtDoc.addEditorKeys(m_jKeys);
    ...
    public void search(CustomerInfo customer) {
        ...
        if (customer == null || customer.getName() == null || customer.getName().equals("")) {
            ...
            m_jtxtDoc.setText(customer.getDoc());
    ...
    public Object createValue() throws BasicException {
        ...
        // TaxID
        if (m_jtxtDoc.getText() == null || m_jtxtDoc.getText().equals("")) {
            afilter[0] = QBFCompareEnum.COMP_NONE;
            afilter[1] = null;
        } else {
            afilter[0] = QBFCompareEnum.COMP_RE;
            afilter[1] = "%" + m_jtxtDoc.getText() + "%";
        }
    ...
    private void initComponents() {
        ...
        m_jtxtDoc = new com.openbravo.editor.JEditorString();
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addComponent(m_jtxtDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel7Layout.createSequentialGroup()
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(m_jtxtDoc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    private com.openbravo.editor.JEditorString m_jtxtDoc;
