...
import com.openbravo.pos.taxes.TaxesLogic;
import com.openbravo.pos.taxes.TaxesException;
...
//    private ScriptObject scriptobjinst;
    ...
    private void refreshTicket() {
        ...
        if (m_oTicket == null) {
            ...
            java.awt.EventQueue.invokeLater(m_jKeyFactory::requestFocus);
        }
    }
    ...
    private boolean closeTicket(TicketInfo ticket, Object ticketext) {
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.Total")) {
            ...
            try {
                ...
                /**
                 * Guardo primero el ticket. Asigno los valores definitivos del
                 * ticket...
                 */
...
//    }
    ...
    private void initComponents() {
        ...
        btnCustomer.setToolTipText(bundle.getString("button.cliente")); // NOI18N
        ...
        btnSplit.setToolTipText(bundle.getString("button.parcial")); // NOI18N
        ...
        m_jUp.setToolTipText(bundle.getString("button.up")); // NOI18N
        ...
        m_jDown.setToolTipText(bundle.getString("button.down")); // NOI18N
        ...
        m_jDelete.setText("(DEL)");
        m_jDelete.setToolTipText(bundle.getString("button.eliminar_item")); // NOI18N
        ...
        m_jList.setText("(F5)");
        m_jList.setToolTipText(bundle.getString("button.buscar_producto")); // NOI18N
        ...
        m_jEditLine.setText("(F6)");
        m_jEditLine.setToolTipText(bundle.getString("button.edit_item")); // NOI18N
        ...
        jEditAttributes.setText("(F7)");
        jEditAttributes.setToolTipText(bundle.getString("button.edit_atrib")); // NOI18N
    ...
    private void m_jKeyFactoryKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_m_jKeyFactoryKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_F2) {
            m_ticketsbag.newTicket();
        }
        if (evt.getKeyCode() == KeyEvent.VK_F3) {
            m_ticketsbag.moveTicket();
        }
