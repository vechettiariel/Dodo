...
public class TaxesLogic {
    ...
    public TaxesLogic(List<TaxInfo> taxlist) {
        ...
        Collections.sort(taxlistordered, (TaxInfo o1, TaxInfo o2) -> {
    ...
    private double sumTaxes(List<TicketTaxInfo> linetaxes) {
        ...
        taxtotal = linetaxes.stream().map((tickettax) -> tickettax.getTax()).reduce(taxtotal, (accumulator, _item) -> accumulator + _item);
        return taxtotal;
    }
