...
public final class TaxEditor extends JPanel implements EditorRecord {
    ...
    public TaxEditor(AppView app, DirtyManager dirty) {
        ...
        txtCodTax.getDocument().addDocumentListener(dirty);
    ...
    public void writeValueDelete(Object value) {
        ...
        txtCodTax.setText(Formats.INT.formatValue(tax[9]));
    ...
    public Object createValue() throws BasicException {
        ...
        tax[9] = Formats.INT.parseValue(txtCodTax.getText());
        return tax;
    }
    ...
    private void initComponents() {
        ...
        txtCodTax = new javax.swing.JTextField();

        setLayout(null);
        add(m_jName);
        m_jName.setBounds(240, 20, 200, 27);

        jLabel2.setText(AppLocal.getIntString("Label.Name")); // NOI18N
        add(jLabel2);
        jLabel2.setBounds(20, 20, 220, 17);

        jLabel3.setText(AppLocal.getIntString("label.dutyrate")); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(20, 140, 220, 17);
        add(m_jRate);
        m_jRate.setBounds(240, 140, 60, 27);

        jLabel1.setText(AppLocal.getIntString("label.taxcategory")); // NOI18N
        add(jLabel1);
        jLabel1.setBounds(20, 50, 220, 17);

        jLabel5.setText(AppLocal.getIntString("label.taxparent")); // NOI18N
        add(jLabel5);
        jLabel5.setBounds(20, 110, 220, 17);

        jCascade.setText(AppLocal.getIntString("label.cascade")); // NOI18N
        add(jCascade);
        jCascade.setBounds(320, 140, 110, 24);
        add(m_jTaxCategory);
        m_jTaxCategory.setBounds(240, 50, 200, 27);
        add(m_jTaxParent);
        m_jTaxParent.setBounds(240, 110, 200, 27);

        jLabel6.setText(AppLocal.getIntString("label.order")); // NOI18N
        add(jLabel6);
        jLabel6.setBounds(20, 170, 220, 17);
        add(jOrder);
        jOrder.setBounds(240, 170, 60, 27);

        jLabel7.setText(AppLocal.getIntString("Label.ValidFrom")); // NOI18N
        add(jLabel7);
        jLabel7.setBounds(20, 80, 120, 17);
        add(txtValidFrom);
        txtValidFrom.setBounds(240, 80, 200, 27);
        ...
        add(btnValidFrom);
        btnValidFrom.setBounds(450, 80, 28, 28);

        jLabel8.setText(AppLocal.getIntString("label.codtax")); // NOI18N
        add(jLabel8);
        jLabel8.setBounds(20, 200, 220, 17);
        add(txtCodTax);
        txtCodTax.setBounds(240, 200, 60, 27);
    ...
    private javax.swing.JTextField txtCodTax;
