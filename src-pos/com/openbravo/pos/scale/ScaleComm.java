...
public class ScaleComm implements Scale, SerialPortEventListener {
    ...
    private void write(byte[] data) {
        ...
        try {
            if (m_out == null) {
                ...
                } catch (NoSuchPortException | PortInUseException | IOException | TooManyListenersException | UnsupportedCommOperationException ex) {
                    Logger.getLogger(ScaleComm.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            m_out.write(data);
    ...
    public void serialEvent(SerialPortEvent e) {
        ...
        switch (e.getEventType()) {
            case SerialPortEvent.BI, SerialPortEvent.OE, SerialPortEvent.FE, SerialPortEvent.PE, SerialPortEvent.CD, SerialPortEvent.CTS, SerialPortEvent.DSR, SerialPortEvent.RI, SerialPortEvent.OUTPUT_BUFFER_EMPTY -> {
            }
